(() => {
  ...
  var powerCount = new CountUp("telemetry--power", 0, {
    ...countOptions,
    decimalPlaces: 1
  });
  var greenPowerCount = new CountUp("telemetry--greenPower", 0, {
    ...countOptions,
    decimalPlaces: 1
  });
  var greenEnergyCount = new CountUp("telemetry--greenEnergy", 0, {
    ...countOptions,
    decimalPlaces: 2
  });
  ...
  function update() {
    fetch("https://api.evcc.io/v1/total").then((response) => response.json()).then(render);
  }
